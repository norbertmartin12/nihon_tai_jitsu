...
public class Database {
    ...
    public Database init() {
        ...
        this.questionList.add(new Question(9,Level.YELLOW,Type.PRACTICE,"Faire son noeud de ceinture","","",""));
        this.questionList.add(new Question(10,Level.YELLOW,Type.PRACTICE,"Salut debout","","",""));
        this.questionList.add(new Question(11,Level.YELLOW,Type.PRACTICE,"Position ZENKUTSU DACHI","","",""));
        this.questionList.add(new Question(12,Level.YELLOW,Type.PRACTICE,"Position KOKUTSU DACHI","","",""));
        this.questionList.add(new Question(13,Level.YELLOW,Type.PRACTICE,"Position SHIKO DACHI","","",""));
        this.questionList.add(new Question(14,Level.YELLOW,Type.PRACTICE,"Salut à genou","","",""));
        this.questionList.add(new Question(15,Level.YELLOW,Type.PRACTICE,"Clé de bras sous l'aisselle - waki gatame","","",""));
        this.questionList.add(new Question(16,Level.YELLOW,Type.PRACTICE,"Clé de bras tendue sur l'épaule - Tenbim Gatame","","",""));
        this.questionList.add(new Question(17,Level.YELLOW,Type.PRACTICE,"Mise en garde classique","","",""));
        this.questionList.add(new Question(18,Level.YELLOW,Type.PRACTICE,"Mise en garde garde mixte","","",""));
        this.questionList.add(new Question(19,Level.YELLOW,Type.PRACTICE,"Mise en garde garde « kempo »","","",""));
        ...
        this.questionList.add(new Question(32,Level.YELLOW,Type.PRACTICE,"Mise en YOI","Un dessin vaut mieux qu'une longue description [image depuis site]","https://ecolekaratemarais.fr/wp-content/uploads/2020/05/Yoi.jpg",""));
        ...
        this.questionList.add(new Question(40,Level.YELLOW,Type.PRACTICE,"Coup de pied direct (mae geri)","[vidéo depuis drive]","","https://drive.google.com/uc?export=view&id=1LT1GWGbBvYtjxeUiO3dcSR1v__hT5qKC"));
        ...
        this.questionList.add(new Question(72,Level.ORANGE,Type.PRACTICE,"Diférentes formes de coup de coude (empi uchi)","Debout pieds écartés et parallèles","",""));
        ...
        this.questionList.add(new Question(81,Level.ORANGE,Type.PRACTICE,"Différentes formes de clé de pouce","","",""));
        ...
        this.questionList.add(new Question(90,Level.ORANGE,Type.PRACTICE,"Projection par l’épaule à l’extérieur –(tenbim nage ou ude kakae)","","",""));
        this.questionList.add(new Question(91,Level.ORANGE,Type.PRACTICE,"chute lattérale plaquée à gauche","","",""));
        this.questionList.add(new Question(92,Level.GREEN,Type.PRACTICE,"Clé de main (2 formes) - kote gatame","","",""));
        ...
        this.questionList.add(new Question(109,Level.GREEN,Type.PRACTICE,"Immobilisation par clé en flexion de bras, uke sur le ventre (kote mawhashi gatame)","","",""));
        ...
        this.questionList.add(new Question(113,Level.GREEN,Type.PRACTICE,"Pression sur point sensible sous les oreilles","","",""));
        this.questionList.add(new Question(114,Level.GREEN,Type.PRACTICE,"Grand fauchage de la jambe extérieur main sur le visage de uke","","",""));
        this.questionList.add(new Question(115,Level.GREEN,Type.PRACTICE,"Etranglement à main nu (hadaka jime)","[vidéo depuis drive]","","https://drive.google.com/uc?export=view&id=1XOv-JA8GokcFIl7UbNeQVfGt0s0dX9vh"));
        ...
        this.questionList.add(new Question(118,Level.GREEN,Type.PRACTICE,"Chute latérale roulée à gauche et à droite","","",""));
        ...
        this.questionList.add(new Question(129,Level.GREEN,Type.PRACTICE,"Démontre yama arashi","","",""));
        ...
        this.questionList.add(new Question(133,Level.BLUE,Type.PRACTICE,"étranglement nu (hadaka jime)","[vidéo depuis drive]","","https://drive.google.com/uc?export=view&id=1XOv-JA8GokcFIl7UbNeQVfGt0s0dX9vh"));
        ...
        this.questionList.add(new Question(139,Level.BLUE,Type.PRACTICE,"Atemi retournés - Ushiro Ura Mawashi Geri","","",""));
        ...
        this.questionList.add(new Question(144,Level.BLUE,Type.PRACTICE,"Tori au sol, uke debout devant (plusieurs formes d’atemi et de ciseaux)","","",""));
        this.questionList.add(new Question(145,Level.BLUE,Type.PRACTICE,"Uke à cheval sur Tori","","",""));
        this.questionList.add(new Question(146,Level.BLUE,Type.PRACTICE,"Uke attaque entre les jambes de Tori","","",""));
        this.questionList.add(new Question(147,Level.BLUE,Type.PRACTICE,"Uke est derrière Tori","","",""));
        this.questionList.add(new Question(148,Level.BLUE,Type.PRACTICE,"Tori renverse Uke","","",""));
        ...
        this.questionList.add(new Question(186,Level.YELLOW,Type.THEORY,"Ceci est un test pour l'affichage d'une image depuis Drive","[image depuis drive]","https://drive.google.com/uc?export=view&id=172c9A0GCUnp36MKm8pD4SCQri1ixwtxQ",""));
